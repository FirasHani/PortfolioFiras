...
const Skills = () => {
  return (
    <section
    id="skills"
   className="w-full lg:w-full xl:w-[2000px] py-20 border-b-[1px] border-b-black"
  >
    <motion.div
      initial={{ opacity: 0 }}
    ...
    >
      <div className="w-full lgl:w-1/2  mt-[40px]">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">tawilwind</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
